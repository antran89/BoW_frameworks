...
function [K_train, K_test] = compute_multichannel_kernel_matrices2(params, action_feature, ini_idx, mode)
% function to compute multi-channel Chi-squared kernel matrices weighted by mean distance (A)
% use mpi-chi2 to compute paire-wise metrics, by Christoph Lampert 
% using opemMP to do parallel processing
