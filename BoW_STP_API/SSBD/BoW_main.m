...
%% set dataset params
params.dataset = 'SSBD';
params.afspath = '/home/beahacker/Public/data/video/ssbd_avi';
...
params.encoding = 'myVQ';               % {VQ, SA, SA-k, LLC, myLLC, SPC, Fisher, FK, VLAD, SVC}, Fisher using Yael lib, FK using Encoding toolbox
