...
fprintf(fid, 'number of evaluation splits: %d\n', params.no_splits);
fprintf(fid, 'number of train samples: %d\n', params.no_train_samples);
fprintf(fid, 'number of test sampls: %d\n', params.no_test_samples);
