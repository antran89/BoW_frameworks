...
%% set dataset params
params.dataset = 'SSBD';
params.afspath = '~/Public/data/video/ssbd_avi';
...
% path to features
params.featurepath = '~/Public/data/video/features/iDT/SSBD';
...
params.encoding = 'myVQ';             % {VQ, SA, SA-k, LLC, SPC, Fisher, FK, VLAD, SV}, Fisher using Yael lib, FK using Encoding toolbox
