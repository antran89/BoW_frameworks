...
%% set dataset params
params.dataset = 'UCF101';
params.afspath = '~/Public/data/video/UCF101';
...
params.avipath = fullfile(params.afspath, 'UCF-101/'); 
params.infopath = fullfile(params.afspath, 'ucfTrainTestlist'); %path for video labels/info

% path to features
params.featurepath = '~/Public/data/video/features/iDT/UCF101';
...
params.no_splits = 3;           %number of splits for UCF101 dataset: 3 splits
...
for idx = 1:params.no_splits
    ...
    clear action_feature;   % explicitly release a large memory
