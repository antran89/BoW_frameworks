...
% path to features
params.featurepath = '~/Public/data/video/features/iDT/HMDB/';
...
params.regionindex = '~/Public/data/video/features/ImprovedDenseTrajectories/newPooled/PooledHMDBFeature_Actionness';
...
params.no_splits = 3;           % 3 train/test splits for HMDB
