...
%% set dataset params
params.dataset = 'UCF-Sports train/test split';
...
% path to features
params.featurepath = '~/Public/data/video/features/ImprovedDenseTrajectories/UCF-Sports';
...
params.regionindex = '~/Public/data/video/features/ImprovedDenseTrajectories/UCF-Sports-PooledFeatures';
...
params.no_splits = 1;           % 1 train/test splits for UCF-Sports
